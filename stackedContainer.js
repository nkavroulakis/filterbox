define(["jquery", "qvangular", "qlik"], function($, qva, qlik) {
 ...
 //           scope: 0,
            ...
            link: function($scope, $element) {
                ...
                //debugger;
                $scope.$watch('stackedMode', function (newValue) {
                    stackContainer($element, $scope);
                })
            }
        }
    })
    ...
    */
    function stackContainer($element, $scope){
        ...
        if (container_width < tabs_width && !$element.parent().hasClass("stacked") || $scope.stackedMode) {
            //debugger;
